...
def get_top_n_words(word_list, top_n=10):
    counter = Counter(word_list)
    top_n_words = counter.most_common(top_n)
    return top_n_words

def plot_top_n_words(top_n_words):
